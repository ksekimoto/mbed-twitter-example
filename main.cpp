...
static void twitter()
{
    ...
    twitter.set_keys((char *)CONSUMER_KEY, (char *)CONSUMER_SECRET, (char *)ACCESS_TOKEN, (char *)ACCESS_TOKEN_SECRET);
#ifdef TARGET_GR_LYCHEE
    twitter.statuses_update("Tweet from MBED GR-LYCHEE Rev.C");
#else
    twitter.statuses_update("Tweet from MBED GR-PEACH Rev.C");
#endif
}
...
int main() {
    ...
    // GET request to developer.mbed.org
    {
        ...
        HttpsRequest* get_req = new HttpsRequest(&wifi, SSL_CA_PEM, HTTP_GET, "https://twitter.com/");
        get_req->set_debug(true);
