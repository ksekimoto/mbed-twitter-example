...
void test_https(NetworkInterface *iface)
{
    // GET request to developer.mbed.org
    {
        printf("\n----- HTTPS GET request -----\n");

        HttpsRequest* get_req = new HttpsRequest(iface, SSL_CA_PEM, HTTP_GET, "https://os.mbed.com/media/uploads/mbed_official/hello.txt");
    ...
    // GET request to developer.mbed.org
    {
        ...
        HttpsRequest* get_req = new HttpsRequest(iface, SSL_CA_PEM, HTTP_GET, "https://twitter.com/");
        get_req->set_debug(true);
    ...
    // POST request to httpbin.org
    {
        ...
        HttpsRequest* post_req = new HttpsRequest(iface, SSL_CA_PEM, HTTP_POST, "https://httpbin.org/post");
